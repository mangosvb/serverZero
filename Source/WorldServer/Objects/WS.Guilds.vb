...
#Region "WS.Guilds.Petition"
    ...
    Public Sub On_CMSG_PETITION_BUY(ByRef packet As PacketClass, ByRef Client As ClientClass)
        ...
        If Client.Character.ItemADD(tmpItem) Then
            ...
            Database.Update(String.Format("INSERT INTO petitions (petition_id, petition_itemGuid, petition_owner, petition_name, petition_type, petition_signedMembers) VALUES ({0}, {0}, {1}, '{2}', {3}, 0);", tmpItem.GUID - GUID_ITEM, Client.Character.GUID - GUID_PLAYER, Name, 9))
        Else
