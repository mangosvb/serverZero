...
Namespace Globals
    ...
    Public Module Packets
        ...
        ''' <returns></returns>
        Public Sub DumpPacket(ByVal data() As Byte, Optional ByRef client As WS_Network.ClientClass = Nothing, Optional ByVal start As Integer = 0)
            '#If DEBUG Then
            Dim j As Integer
        ...
        Public Class UpdateClass
            ...
            ''' <returns></returns>
            Public Sub AddToPacket(ByRef packet As PacketClass, ByVal updateType As ObjectUpdateType, ByRef updateObject As WS_Creatures.CreatureObject)
            ...
            ''' <param name="updateObject">The update object.</param>
            ''' <returns></returns>
            Public Sub AddToPacket(ByRef packet As PacketClass, ByVal updateType As ObjectUpdateType, ByRef updateObject As WS_PlayerData.CharacterObject)
                packet.AddInt8(updateType)
                packet.AddPackGUID(updateObject.GUID)
