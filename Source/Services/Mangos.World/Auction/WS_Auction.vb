...
#Region "WS.Auction.Constants"
        ...
        Public Sub AuctionCreateMail(ByVal MailAction As MailAuctionAction, ByVal AuctionLocation As AuctionHouses, ByVal ReceiverGUID As ULong, ByVal ItemID As Integer, ByRef packet As Packets.PacketClass)
