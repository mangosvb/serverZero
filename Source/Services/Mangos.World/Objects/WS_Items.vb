...
#Region "WS.Items.Handlers"
        ...
        Public Sub SendItemInfo(ByRef client As WS_Network.ClientClass, ByVal itemID As Integer)
            Dim response As New Packets.PacketClass(OPCODES.SMSG_ITEM_QUERY_SINGLE_RESPONSE)
