...
#Region "GraveYards"
        Public Sub InitializeGraveyards()
            Try
                Graveyards.Clear()
                Dim tmpDBC As BufferedDbc = New BufferedDbc("dbc" & Path.DirectorySeparatorChar & "WorldSafeLocs.dbc")
...
#End Region
        ...
        Public Sub GoToNearestGraveyard(ByRef Character As WS_PlayerData.CharacterObject, ByVal Alive As Boolean, ByVal Teleport As Boolean)
