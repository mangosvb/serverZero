...
Namespace Creatures
    Public Class CreatureAI_The_Plains_Vision
        ...
        Private Sub InitWaypoints()
            Waypoints.Add(New WS_DBCDatabase.CreatureMovePoint(-2239.839, -404.8294, -9.424251, 0, 0, 0, 100))
            Waypoints.Add(New WS_DBCDatabase.CreatureMovePoint(-2224.553, -419.0978, -9.319928, 0, 0, 0, 100))
