...
#Region "WS.Spells.Constants"
    ...
    Public Enum SpellFailedReason As Byte
        ...
        SPELL_FAILED_AUTOTRACK_INTERRUPTED = &H8                        ' 0x008
        ...
        SPELL_FAILED_CANT_CAST_ON_TAPPED = &HD                          ' 0x00D
        SPELL_FAILED_CANT_DUEL_WHILE_INVISIBLE = &HE                    ' 0x00E
        SPELL_FAILED_CANT_DUEL_WHILE_STEALTHED = &HF                    ' 0x00F
        SPELL_FAILED_CANT_STEALTH = &H10                                ' 0x010
        SPELL_FAILED_CASTER_AURASTATE = &H11                            ' 0x011
        SPELL_FAILED_CASTER_DEAD = &H12                                 ' 0x012
        SPELL_FAILED_CHARMED = &H13                                     ' 0x013
        SPELL_FAILED_CHEST_IN_USE = &H14                                ' 0x014
        SPELL_FAILED_CONFUSED = &H15                                    ' 0x015
        SPELL_FAILED_DONT_REPORT = &H16                                 ' 0x016
        SPELL_FAILED_EQUIPPED_ITEM = &H17                               ' 0x017
        SPELL_FAILED_EQUIPPED_ITEM_CLASS = &H18                         ' 0x018
        SPELL_FAILED_EQUIPPED_ITEM_CLASS_MAINHAND = &H19                ' 0x019
        SPELL_FAILED_EQUIPPED_ITEM_CLASS_OFFHAND = &H1A                 ' 0x01A
        SPELL_FAILED_ERROR = &H1B                                       ' 0x01B
        SPELL_FAILED_FIZZLE = &H1C                                      ' 0x01C
        SPELL_FAILED_FLEEING = &H1D                                     ' 0x01D
        SPELL_FAILED_FOOD_LOWLEVEL = &H1E                               ' 0x01E
        SPELL_FAILED_HIGHLEVEL = &H1F                                   ' 0x01F
        SPELL_FAILED_HUNGER_SATIATED = &H20                             ' 0x020
        SPELL_FAILED_IMMUNE = &H21                                      ' 0x021
        SPELL_FAILED_INTERRUPTED = &H22                                 ' 0x022
        SPELL_FAILED_INTERRUPTED_COMBAT = &H23                          ' 0x023
        SPELL_FAILED_ITEM_ALREADY_ENCHANTED = &H24                      ' 0x024
        SPELL_FAILED_ITEM_GONE = &H25                                   ' 0x025
        SPELL_FAILED_ITEM_NOT_FOUND = &H26                              ' 0x026
        SPELL_FAILED_ITEM_NOT_READY = &H27                              ' 0x027
        SPELL_FAILED_LEVEL_REQUIREMENT = &H28                           ' 0x028
        SPELL_FAILED_LINE_OF_SIGHT = &H29                               ' 0x029
        SPELL_FAILED_LOWLEVEL = &H2A                                    ' 0x02A
        SPELL_FAILED_LOW_CASTLEVEL = &H2B                               ' 0x02B
        SPELL_FAILED_MAINHAND_EMPTY = &H2C                              ' 0x02C
        SPELL_FAILED_MOVING = &H2D                                      ' 0x02D
        SPELL_FAILED_NEED_AMMO = &H2E                                   ' 0x02E
        SPELL_FAILED_NEED_AMMO_POUCH = &H2F                             ' 0x02F
        SPELL_FAILED_NEED_EXOTIC_AMMO = &H30                            ' 0x030
        SPELL_FAILED_NOPATH = &H31                                      ' 0x031
        SPELL_FAILED_NOT_BEHIND = &H32                                  ' 0x032
        SPELL_FAILED_NOT_FISHABLE = &H33                                ' 0x033
        SPELL_FAILED_NOT_HERE = &H34                                    ' 0x034
        SPELL_FAILED_NOT_INFRONT = &H35                                 ' 0x035
        SPELL_FAILED_NOT_IN_CONTROL = &H36                              ' 0x036
        SPELL_FAILED_NOT_KNOWN = &H37                                   ' 0x037
        SPELL_FAILED_NOT_MOUNTED = &H38                                 ' 0x038
        SPELL_FAILED_NOT_ON_TAXI = &H39                                 ' 0x039
        SPELL_FAILED_NOT_ON_TRANSPORT = &H3A                            ' 0x03A
        SPELL_FAILED_NOT_READY = &H3B                                   ' 0x03B
        SPELL_FAILED_NOT_SHAPESHIFT = &H3C                              ' 0x03C
        SPELL_FAILED_NOT_STANDING = &H3D                                ' 0x03D
        SPELL_FAILED_NOT_TRADEABLE = &H3E                               ' 0x03E
        SPELL_FAILED_NOT_TRADING = &H3F                                 ' 0x03F
        SPELL_FAILED_NOT_UNSHEATHED = &H40                              ' 0x040
        SPELL_FAILED_NOT_WHILE_GHOST = &H41                             ' 0x041
        SPELL_FAILED_NO_AMMO = &H42                                     ' 0x042
        SPELL_FAILED_NO_CHARGES_REMAIN = &H43                           ' 0x043
        SPELL_FAILED_NO_CHAMPION = &H44                                 ' 0x044
        SPELL_FAILED_NO_COMBO_POINTS = &H45                             ' 0x045
        SPELL_FAILED_NO_DUELING = &H46                                  ' 0x046
        SPELL_FAILED_NO_ENDURANCE = &H47                                ' 0x047
        SPELL_FAILED_NO_FISH = &H48                                     ' 0x048
        SPELL_FAILED_NO_ITEMS_WHILE_SHAPESHIFTED = &H49                 ' 0x049
        SPELL_FAILED_NO_MOUNTS_ALLOWED = &H4A                           ' 0x04A
        SPELL_FAILED_NO_PET = &H4B                                      ' 0x04B
        SPELL_FAILED_NO_POWER = &H4C                                    ' 0x04C
        SPELL_FAILED_NOTHING_TO_DISPEL = &H4D                           ' 0x04D
        SPELL_FAILED_ONLY_ABOVEWATER = &H4E                             ' 0x04E
        SPELL_FAILED_ONLY_DAYTIME = &H4F                                ' 0x04F
        SPELL_FAILED_ONLY_INDOORS = &H50                                ' 0x050
        SPELL_FAILED_ONLY_MOUNTED = &H51                                ' 0x051
        SPELL_FAILED_ONLY_NIGHTTIME = &H52                              ' 0x052
        SPELL_FAILED_ONLY_OUTDOORS = &H53                               ' 0x053
        SPELL_FAILED_ONLY_SHAPESHIFT = &H54                             ' 0x054
        SPELL_FAILED_ONLY_STEALTHED = &H55                              ' 0x055
        SPELL_FAILED_ONLY_UNDERWATER = &H56                             ' 0x056
        SPELL_FAILED_OUT_OF_RANGE = &H57                                ' 0x057
        SPELL_FAILED_PACIFIED = &H58                                    ' 0x058
        SPELL_FAILED_POSSESSED = &H59                                   ' 0x059
        SPELL_FAILED_REAGENTS = &H5A                                    ' 0x05A
        SPELL_FAILED_REQUIRES_AREA = &H5B                               ' 0x05B
        SPELL_FAILED_REQUIRES_SPELL_FOCUS = &H5C                        ' 0x05C
        SPELL_FAILED_ROOTED = &H5D                                      ' 0x05D
        SPELL_FAILED_SILENCED = &H5E                                    ' 0x05E
        SPELL_FAILED_SPELL_IN_PROGRESS = &H5F                           ' 0x05F
        SPELL_FAILED_SPELL_LEARNED = &H60                               ' 0x060
        SPELL_FAILED_SPELL_UNAVAILABLE = &H61                           ' 0x061
        SPELL_FAILED_STUNNED = &H62                                     ' 0x062
        SPELL_FAILED_TARGETS_DEAD = &H63                                ' 0x063
        SPELL_FAILED_TARGET_AFFECTING_COMBAT = &H64                     ' 0x064
        SPELL_FAILED_TARGET_AURASTATE = &H65                            ' 0x065
        SPELL_FAILED_TARGET_DUELING = &H66                              ' 0x066
        SPELL_FAILED_TARGET_ENEMY = &H67                                ' 0x067
        SPELL_FAILED_TARGET_ENRAGED = &H68                              ' 0x068
        SPELL_FAILED_TARGET_FRIENDLY = &H69                             ' 0x069
        SPELL_FAILED_TARGET_IN_COMBAT = &H6A                            ' 0x06A
        SPELL_FAILED_TARGET_IS_PLAYER = &H6B                            ' 0x06B
        SPELL_FAILED_TARGET_NOT_DEAD = &H6C                             ' 0x06C
        SPELL_FAILED_TARGET_NOT_IN_PARTY = &H6D                         ' 0x06D
        SPELL_FAILED_TARGET_NOT_LOOTED = &H6E                           ' 0x06E
        SPELL_FAILED_TARGET_NOT_PLAYER = &H6F                           ' 0x06F
        SPELL_FAILED_TARGET_NO_POCKETS = &H70                           ' 0x070
        SPELL_FAILED_TARGET_NO_WEAPONS = &H71                           ' 0x071
        SPELL_FAILED_TARGET_UNSKINNABLE = &H72                          ' 0x072
        SPELL_FAILED_THIRST_SATIATED = &H73                             ' 0x073
        SPELL_FAILED_TOO_CLOSE = &H74                                   ' 0x074
        SPELL_FAILED_TOO_MANY_OF_ITEM = &H75                            ' 0x075
        SPELL_FAILED_TOTEMS = &H76                                      ' 0x076
        SPELL_FAILED_TRAINING_POINTS = &H77                             ' 0x077
        SPELL_FAILED_TRY_AGAIN = &H78                                   ' 0x078
        SPELL_FAILED_UNIT_NOT_BEHIND = &H79                             ' 0x079
        SPELL_FAILED_UNIT_NOT_INFRONT = &H7A                            ' 0x07A
        SPELL_FAILED_WRONG_PET_FOOD = &H7B                              ' 0x07B
        SPELL_FAILED_NOT_WHILE_FATIGUED = &H7C                          ' 0x07C
        SPELL_FAILED_TARGET_NOT_IN_INSTANCE = &H7D                      ' 0x07D
        SPELL_FAILED_NOT_WHILE_TRADING = &H7E                           ' 0x07E
        SPELL_FAILED_TARGET_NOT_IN_RAID = &H7F                          ' 0x07F
        SPELL_FAILED_DISENCHANT_WHILE_LOOTING = &H80                    ' 0x080
        SPELL_FAILED_TARGET_FREEFORALL = &H81                           ' 0x081
        SPELL_FAILED_NO_EDIBLE_CORPSES = &H82                           ' 0x082
        SPELL_FAILED_ONLY_BATTLEGROUNDS = &H83                          ' 0x083
        SPELL_FAILED_TARGET_NOT_GHOST = &H84                            ' 0x084
        SPELL_FAILED_TOO_MANY_SKILLS = &H85                             ' 0x085
        SPELL_FAILED_TRANSFORM_UNUSABLE = &H86                          ' 0x086
        SPELL_FAILED_WRONG_WEATHER = &H87                               ' 0x087
        SPELL_FAILED_DAMAGE_IMMUNE = &H88                               ' 0x088
        SPELL_FAILED_PREVENTED_BY_MECHANIC = &H89                       ' 0x089
        SPELL_FAILED_PLAY_TIME = &H8A                                   ' 0x08A
        SPELL_FAILED_REPUTATION = &H8B                                  ' 0x08B
        SPELL_FAILED_UNKNOWN = &H8C                                     ' 0x08C
