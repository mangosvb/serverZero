...
Public Class NativeMethods
    ...
    Public Shared Function BN_add(ByVal r As IntPtr, ByVal a As IntPtr, ByVal b As IntPtr, Optional ByVal dummy As String = "") As Integer
        Return BN_add(r, a, b)
    End Function

    Private Declare Function BN_sub Lib "LIBEAY32" (ByVal r As IntPtr, ByVal a As IntPtr, ByVal b As IntPtr) As Integer

    Public Shared Function BN_sub(ByVal r As IntPtr, ByVal a As IntPtr, ByVal b As IntPtr, Optional ByVal dummy As String = "") As Integer
        Return BN_sub(r, a, b)
    End Function
    ...
    Public Shared Function BN_bin2bn(ByVal ByteArrayIn As Byte(), ByVal length As Integer, ByVal [to] As IntPtr, Optional ByVal dummy As String = "") As IntPtr
    ...
    Public Shared Function BN_bn2bin(ByVal a As IntPtr, ByVal [to] As Byte(), Optional ByVal dummy As String = "") As Integer
    ...
    Public Shared Function BN_CTX_new(Optional ByVal dummy As String = "") As Integer
        Return BN_CTX_new()
    End Function
    ...
    Public Shared Function BN_mod(ByVal r As IntPtr, ByVal a As IntPtr, ByVal b As IntPtr, ByVal ctx As IntPtr, Optional ByVal dummy As String = "") As Integer
    ...
    Public Shared Function BN_mod_exp(ByVal res As IntPtr, ByVal a As IntPtr, ByVal p As IntPtr, ByVal m As IntPtr, ByVal ctx As IntPtr, Optional ByVal dummy As String = "") As IntPtr
    ...
    Public Shared Function BN_mul(ByVal r As IntPtr, ByVal a As IntPtr, ByVal b As IntPtr, ByVal ctx As IntPtr, Optional ByVal dummy As String = "") As Integer
    ...
    Public Shared Function BN_new(Optional ByVal dummy As String = "") As IntPtr
        Return BN_new()
    End Function
    ...
    Public Shared Function RAND_bytes(ByVal buf As Byte(), ByVal num As Integer, Optional ByVal dummy As String = "") As Integer
...
#Else
    ...
    Public Shared Function timeGetTime(Optional ByVal dummy As String = "") As Integer
        Return timeGetTime()
    End Function
    Public Shared Function timeBeginPeriod(ByVal uPeriod As Integer, Optional ByVal dummy As String = "") As Integer
...
#End If
    ...
    Public Shared Function BN_div(ByVal dv As IntPtr, ByVal remainder As IntPtr, ByVal a As IntPtr, ByVal d As IntPtr, ByVal ctx As IntPtr, Optional ByVal dummy As String = "") As Integer
    ...
    Public Shared Function BN_sqr(ByVal r As IntPtr, ByVal a As IntPtr, ByVal ctx As IntPtr, Optional ByVal dummy As String = "") As Integer
    ...
    Public Shared Function BN_exp(ByVal r As IntPtr, ByVal a As IntPtr, ByVal p As IntPtr, ByVal ctx As IntPtr, Optional ByVal dummy As String = "") As Integer
    ...
    Public Shared Function BN_lshift(ByVal r As IntPtr, ByVal a As IntPtr, ByVal n As Integer, Optional ByVal dummy As String = "") As Integer
    ...
    Public Shared Function BN_rshift(ByVal r As IntPtr, ByVal a As IntPtr, ByVal n As Integer, Optional ByVal dummy As String = "") As Integer
        Return BN_rshift(r, a, n)
    End Function

    Private Declare Function BN_num_bits Lib "LIBEAY32" (ByVal a As IntPtr) As Integer

    Public Shared Function BN_num_bits(ByVal a As IntPtr, Optional ByVal dummy As String = "") As Integer
    ...
    Public Shared Function LoadLibrary(ByVal lpLibFileName As String, Optional ByVal dummy As String = "") As Integer
    ...
    Public Shared Function VirtualProtect(ByVal lpAddress As Integer, ByVal dwSize As Integer, ByVal flNewProtect As Integer, ByRef lpflOldProtect As Integer, Optional ByVal dummy As String = "") As Integer
    ...
    Public Shared Function FlushInstructionCache(ByVal hProcess As Integer, ByVal lpBaseAddress As Integer, ByVal dwSize As Integer, Optional ByVal dummy As String = "") As Integer
    ...
    Public Shared Function GetCurrentProcess(Optional ByVal dummy As String = "") As Integer
    ...
    Public Shared Function VirtualFree(ByVal lpAddress As Integer, ByVal dwSize As Integer, ByVal dwFreeType As Integer, Optional ByVal dummy As String = "") As Integer
        Return VirtualFree(lpAddress, dwSize, dwFreeType)
    End Function


    Private Declare Function GlobalLock Lib "kernel32.dll" (ByVal hMem As Integer) As Integer
    Public Shared Function GlobalLock(ByVal hMem As Integer, Optional ByVal dummy As String = "") As Integer
        Return GlobalLock(hMem)
    End Function

    Private Declare Function GlobalUnlock Lib "kernel32.dll" (ByVal hMem As Integer) As Integer
    Public Shared Function GlobalUnlock(ByVal hMem As Integer, Optional ByVal dummy As String = "") As Integer
